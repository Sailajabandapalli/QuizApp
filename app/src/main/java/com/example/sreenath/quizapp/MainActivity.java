...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            myIndex=savedInstanceState.getInt("IndexKey");
        ...
        //TrueFalse firstQuestion=mQuestionBank[myIndex];
        mQuestion=mQuestionBank[myIndex].getmQuestionId();
    ...
    private void updateQuestion(){
        ...
        if(myIndex==0){
            ...
            alert.setPositiveButton("CloseApplication", new DialogInterface.OnClickListener() {
                @Override
    ...
    private void checkAnswer(boolean userSelection) {
        boolean correctAnswer = mQuestionBank[myIndex].ismAnswer();
        ...
        outState.putInt("IndexKey",myIndex);
        }
